...
static char *fonts[]          = { "monospace:pixelsize=10", "NotoColorEmoji:pixelsize=10:antialias=true:autohint=true"  };
...
static const Key keys[] = {
    ...
    { MODKEY|ShiftMask,		XK_backslash,		spawn,		{.v = (const char*[]){ "passotpmenu", NULL } } },

	{ MODKEY,			XK_a,		togglegaps,	{0} },
	{ MODKEY|ShiftMask,		XK_a,		defaultgaps,	{0} },
	{ MODKEY,			XK_s,		togglesticky,	{0} },
	{ MODKEY|ShiftMask,		XK_s,		spawn,		SHCMD("soxy-ref > /dev/null") },
	// { MODKEY,			XK_d,		spawn,          {.v = (const char*[]){ "dmenu_run", NULL } } },
	{ MODKEY,			XK_d,		spawn,          SHCMD("dmenu_run -i") },
...
/* 	{ MODKEY,			XK_n,		spawn,		{.v = (const char*[]){ TERMINAL, "-e", "nvim", "-c", "VimwikiIndex", NULL } } }, */
	...
	{ 0, XF86XK_AudioMute,		spawn,		SHCMD("pamixer --toggle-mute  toggle; kill -44 $(pidof dwmblocks)") },
